...
- Pages get a **360 px layout viewport** scaled to fit the 320 px glasses screen — responsive sites (Google, YouTube…) render their phone layout instead of cramming into 320 px
...
```bash
adb install -r releases/rokid-glass-browser-1.14.1.apk
```
